...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mErrorMessageTextView=null;

    // COMPLETE (16) Add a ProgressBar variable to show and hide the progress bar
    private ProgressBar mLoadingDataProgressBar=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoadingDataProgressBar=(ProgressBar) findViewById(R.id.pb_loading_weather_data);
    ...
    // COMPLETE (8) Create a method called showWeatherDataView that will hide the error message and
    // show the weather data View
    ...
    // COMPLETE (9) Create a method called showErrorMessage that will hide the weather data and show
    // the error message
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        // COMPLETE (18) Within your AsyncTask, override the method onPreExecute and show the
        // loading
        // indicator
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            if (weatherData != null) {
                // COMPLETE (11) If the weather data was not null, make sure the data view is
                // visible
                showWeatherDataView();
                /*
                ...
                Log.d(TAG, mWeatherTextView.toString());
            }else {
